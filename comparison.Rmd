...
all.equal(zoomsstest$model$N[1,,] , zoomizertest@params@initial_n * zoomizertest@params@dw, check.attributes=FALSE)
...
no_sp <- nrow(params@species_params) # number of species
  ...
  e_growth <- new_EReproAndGrowth(params = params, n = params@initial_n, n_pp = params@initial_n_pp, n_other = params@initial_n_other, t = 1, encounter = getEncounter(params), feeding_level = getFeedingLevel(params))
  mort <- getMort(params)
