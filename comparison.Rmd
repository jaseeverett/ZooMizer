...
source("../ZooMSS/fZooMSS_Model.R") #source the model code
source("../ZooMSS/fZooMSS_Setup.R")
...
#abundances
all.equal(zoomsstest$model$nPP ,zoomizertest@n_pp[1,1:length(zoomsstest$model$nPP)], check.attributes=FALSE)
