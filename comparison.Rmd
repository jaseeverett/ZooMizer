...
all.equal(zoomsstest$model$param$w_phyto, zoomizertest@params@w_full[1:64],check.attributes=FALSE)

#abundances
all.equal(zoomsstest$model$nPP ,zoomizertest@n_pp[1,1:64], check.attributes=FALSE)
