...
all.equal(zoomizeregrowth, gg, check.attributes=FALSE) #it was really close earlier with zoomizeregrowth/w, now mizer's N is in 1/g so perhaps this is the right conversion?
```
...
all.equal(phyto_predkernel[5,,], zoomizerpredkernel[5,,1:71], check.attributes=FALSE)   #FALSE CarnCopepods
all.equal(phyto_predkernel[6,,], zoomizerpredkernel[6,,1:71], check.attributes=FALSE)   #FALSE Euphausiids
all.equal(phyto_predkernel[7,,], zoomizerpredkernel[7,,1:71], check.attributes=FALSE)   #FALSE Chaetognaths
...
all.equal(phyto_predkernel[10,,], zoomizerpredkernel[10,,1:71], check.attributes=FALSE) #FALSE Fish_Small
all.equal(phyto_predkernel[11,,], zoomizerpredkernel[11,,1:71], check.attributes=FALSE) #FALSE Fish_Med
all.equal(phyto_predkernel[12,,], zoomizerpredkernel[12,,1:71], check.attributes=FALSE) #FALSE Fish_Large
...
all.equal(dynam_predkernel[6,,], zoomizerpredkernel[6,,39:216], check.attributes=FALSE)   #FALSE Euphausiids
all.equal(dynam_predkernel[7,,], zoomizerpredkernel[7,,39:216], check.attributes=FALSE)   #FALSE Chaetognaths
...
all.equal(dynam_predkernel[10,,], zoomizerpredkernel[10,,39:216], check.attributes=FALSE) #FALSE Fish_Small
all.equal(dynam_predkernel[11,,], zoomizerpredkernel[11,,39:216], check.attributes=FALSE) #FALSE Fish_Med
all.equal(dynam_predkernel[12,,], zoomizerpredkernel[12,,39:216], check.attributes=FALSE) #FALSE Fish_Large
